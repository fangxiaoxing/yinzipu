	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<div class="rt_content">
			...
			<form action="product/insertProduct.do" method="post" enctype="multipart/form-data">
				<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">对公利率（%）<span class="add_info">*</span></span> 
						<input type="text" name="inteComp" class="textbox textbox_295" /></li>
					<li><span class="item_name" style="width: 120px;">对私利率（%）<span class="add_info">*</span></span>
						<input type="text" name="inteUser" onblur="change()" class="textbox textbox_295" /></li>
