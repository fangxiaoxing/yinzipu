			...
			<form action="product/insertProduct.do" method="post" enctype="multipart/form-data">
				<ul class="ulColumn2">
					...
					<li><span class="item_name" style="width: 120px;">汽车图片<span class="add_info">*</span></span>
						...
						<input type="file" name="carPhoto3" onchange="previewImage(this)" /><input type="checkbox" onclick="showNext(this)" value="0" />添加
						<input type="file" name="carPhoto4" onchange="previewImage(this)" /><input type="checkbox" onclick="showNext(this)" value="0" />添加
