	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<div class="rt_content">
			...
			<form action="product/insertProduct.do" method="post" enctype="multipart/form-data">
				<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">简介内容<span class="add_info">*</span></span> </li>
						<li><textarea name="intrTxt" style="border:2px solid lightgreen;width: 400px;height: 300px;" placeholder="请少于200个字"></textarea></li>
