	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<div class="rt_content">
			<div class="page_title_iframe">
				<h2 class="fl">新增产品期限</h2>
			</div>
			<form action="product/insertProduct.do" method="post" enctype="multipart/form-data">
				<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">产品期限（月）<span class="add_info">*</span></span> 
						<input type="text" name="dateLength" class="textbox textbox_295" /></li>
							<li><span class="item_name" style="width: 120px;"></span> <input type="button" onclick="addProduct()" value="新增产品期限" class="link_btn" /></li>
				</ul>
			</form>
