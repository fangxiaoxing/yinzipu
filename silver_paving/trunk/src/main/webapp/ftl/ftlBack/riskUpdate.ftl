	...
	<section class="rt_wrap content mCustomScrollbar">
		...
		<div class="rt_content">
			...
			<form action="product/insertProduct.do" method="post" enctype="multipart/form-data">
				<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">产品名称<span class="add_info">*</span></span> <input type="text" name="ownerName" class="textbox textbox_295" /></li>
					<li><span class="item_name" style="width: 120px;">产品编码<span class="add_info">*</span></span>
					...
					<li><span class="item_name" style="width: 120px;">结束时间<span class="add_info">*</span></span> <input type="text" name="productModel" class="textbox textbox_295" /></li>
					...
					<li><span class="item_name" style="width: 120px;">已借款金额<span class="add_info">*</span></span>
					...
					<li>
						<li><span class="item_name" style="width: 120px;">未借款金额（元）<span class="add_info">*</span></span>
							<input type="text" name="productLoan" class="textbox textbox_295" /></li>
						<li>
							<li><span class="item_name" style="width: 120px;">产品类型<span class="add_info">*</span></span>
								<input type="text" name="productTerm" class="textbox textbox_295" /></li>
							<li><span class="item_name" style="width: 120px;">还款方式<span class="add_info">*</span></span> <label class="single_selection"><input type="radio" name="productPay" checked="checked" value="0"/>按月还息，到期还本</label>
							...
							<li><span class="item_name" style="width: 120px;">借款协议书<span class="add_info">*</span></span>
								<input type="file" name="loanAgreement1" onchange="previewImage(this)" /><input type="checkbox" onclick="showNext(this)" value="0" />添加
								<input class="more" type="file" name="loanAgreement2" onchange="previewImage(this)" />
							</li>
